...
for i in range(19, 7, -1):
    ...
    (driver.find_element("xpath", '/html/body/main/div/div/div[2]/div/div/nba-stat-table/div[1]/div/div/select/option[@value="string:All"]')[0]).click()
    time.sleep(5)
